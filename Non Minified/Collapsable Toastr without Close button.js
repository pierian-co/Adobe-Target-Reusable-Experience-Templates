...
var delay = setInterval(function() {
	...
	offerBadgeOut.insertAdjacentHTML('afterend', '<div class="offerbox_out"> <div><div class="offerbox_headline"><span class="s_headline" style="color:' + config_toastr_v2.message.colour + '">' + s_headline + '</span> </div><div class="offerbox_in"><div class="innerflex1"> <div class="benefits"> <div class="inner_benefits"> <i class="check_per"></i> <a href="'+config_toastr_v2.subHeading.subHeading1Href+'"><span class="innerspan">' + s_benefit1 + '</span></a> </div><div class="inner_benefits"><i class="check_per"></i> <a href="'+config_toastr_v2.subHeading.subHeading2Href+'"><span class="innerspan">' + s_benefit2 + '</span></a> </div><div class="inner_benefits"><i class="check_per"></i> <a href="'+config_toastr_v2.subHeading.subHeading3Href+'"><span class="innerspan">' + s_benefit3 + '</span></a> </div></div></div><div class="innerflex2"> <a class="red-cta-link" href="' + s_ctared_link + '"style="color: inherit;display: inline-block;text-decoration: none;"><button type="button" class="red-cta">' + s_ctared + '</button></a> <a class="white-cta-link" href="' + s_ctawhite_link + '"style="color: inherit;display: inline-block;text-decoration: none;"><button type="button" class="white-cta">' + s_ctawhite + '</button></a> </div></div></div></div>');
	...
	if(config_toastr_v2.autoHide.flag == "yes") {
		...
		var sec = 0;
		document.querySelector(".mid .offerbadge_out").insertAdjacentHTML('afterbegin', '<p class="offerbadge_timer offerbadge"></p>');
		var e = 0;
		var timer = setInterval(function() {
			if(++e === config_toastr_v2.autoHide.time) {
				clearInterval(timer)
			}
			var t = config_toastr_v2.autoHide.time - e;
			document.querySelector(".offerbadge_timer").innerHTML = config_toastr_v2.autoHide.countDownText + " " + t + " seconds";
		}, 1e3);
