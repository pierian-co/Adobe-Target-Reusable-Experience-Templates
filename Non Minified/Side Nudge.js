...
} else if(config_sideNudge.SideBannerStyle.backgroundColor != "") {
	document.querySelector(".psb_nudge").style.backgroundColor = config_sideNudge.SideBannerStyle.backgroundColor;
}
