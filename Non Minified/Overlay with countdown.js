...
var config_overlay = {
    ...
    "countdown": {
        "activator": "yes",
        "date": "May 25, 2022 12:00:00" // May 25, 2022 12:00:00
    }
};
		...
		var imginsert = setInterval(function() {
			if(document.querySelectorAll(".psb").length == 0) {
                ...
                function initCountDown() {
                    var countDownDate = new Date(config_overlay.countdown.date).getTime();
