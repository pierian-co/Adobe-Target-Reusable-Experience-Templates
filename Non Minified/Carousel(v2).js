var config_carousal_v2 = {
    ...
    "bannerPosition": {
        "selector": "#mph-flex-container-632063 > div > div" // div was not appending but corrected
    },
    "background": {
...
if(config_carousal_v2.Product1.Offer.flag=="yes"){
    ...
    sel.insertAdjacentHTML("afterbegin",'<span class="offer-div">'+config_carousal_v2.Product1.Offer.text+'</span>');
}
else{
...
if(config_carousal_v2.Product2.Offer.flag=="yes"){
    ...
    sel.classList.add("new-offer");
    sel.insertAdjacentHTML("afterbegin",'<span class="offer-div">'+config_carousal_v2.Product2.Offer.text+'</span>');
}
else{
...
if(config_carousal_v2.Product3.Offer.flag=="yes"){
    ...
    sel.classList.add("new-offer");
    sel.insertAdjacentHTML("afterbegin",'<span class="offer-div">'+config_carousal_v2.Product3.Offer.text+'</span>');
}
else{
