			...
			if(0 == document.querySelectorAll(".psb_temp1").length) {
				if(document.querySelectorAll(config_temp1.bannerPosition.selector).length > 0) {
					if(function(t, e) {
							...
							_.id = "mid_temp1", _.style.borderWidth = t.borderStyle.width, _.style.borderStyle = t.borderStyle.style, _.style.borderColor = t.borderStyle.colour, "" != config_temp1.background.imageUrl ? _.style.backgroundImage = "url('" + config_temp1.background.imageUrl + "')" : _.style.backgroundColor = t.background.backgroundColour, _.appendChild(n);
						...
						n = setInterval(function() {
							++e === config_temp1.autoHide.time && (o(document.getElementById("mid_temp1"), 2e3), clearInterval(n));
					...
					"yes" == config_temp1.collapseAndExpandButton.flag && (document.querySelector("#did1_temp1").onclick = function() {
						document.querySelector("#did1_temp1").classList.toggle("down_temp1"), o(document.getElementById("bnr1_temp1"), 2e3)
					}), "yes" != config_temp1.closeButton.flag && (document.querySelector("#closebtn2_temp1").style.display = "none"), document.querySelector("#closebtn2_temp1").onclick = function() {
						o(document.getElementById("mid_temp1"), 2e3)
					}, "none" == config_temp1.ctaCount.singleCTA && "yes" == config_temp1.ctaLink2.closeButton && (document.querySelector("#closeb_temp1").setAttribute("href", "javascript:void(0)"), document.querySelector("#closeb_temp1").setAttribute("target", "_self"), document.querySelectorAll(".btn_temp1")[1].onclick = function() {
						o(document.getElementById("mid_temp1"), 2e3)
					})
