...
<div class="carousel" id="carousel-one-by-one">
  ...
  <div class="slide">
    <a href="${carousel_settings.slide2.href}" target="_blank" style="background: ${carousel_settings.slide2.backgroundColor}; text-decoration:none;display: inline-block;width: 100%;"
      tabindex="0">
      <span class="product-label">Lorum ipsumdoluiu</span>
  ...
  <div class="slide">
    <a href="${carousel_settings.slide3.href}" target="_blank" style="background: ${carousel_settings.slide3.backgroundColor};text-decoration:none;display: inline-block;width: 100%;"
      tabindex="0">
...
var carouselOneByOne = new PureJSCarousel({
    carousel: carousel_settings.initSlider.carousel,
    slide: carousel_settings.initSlider.slide,
    oneByOne: carousel_settings.initSlider.oneByOne,
    btnNext: carousel_settings.initSlider.btnNext,
    btnRight: carousel_settings.initSlider.btnRight,
    speed: carousel_settings.initSlider.speed,
    delay: carousel_settings.initSlider.delay,
    effect: carousel_settings.initSlider.effect,
    infinite: carousel_settings.initSlider.infinite,
    autoplay: carousel_settings.initSlider.autoplay,
    autoplayDelay: carousel_settings.initSlider.autoplayDelay,
    autoplayDirection: carousel_settings.initSlider.autoplayDirection
});