        ...
        var t = setInterval(function() {
            if (0 == document.querySelectorAll(".psb").length) {
                if (function(t, e) {
                        ...
                        o.className = "descriptionText", o.style.textAlign = "center", o.style.padding = "0px 10px 0px 10px", o.style.color = t.message.colour;
                        ...
                        m.setAttribute("href", t.ctaLink2.href), m.setAttribute("id", "closeb"), m.innerHTML = t.ctaLink2.text, m.style.borderRadius = t.ctaLink2.borderRadius, m.style.backgroundColor = t.ctaLink2.backgroundColour, m.style.fontFamily = t.ctaLink2.fontFamily, m.style.padding = "6px 10px 6px 10px", m.style.color = t.ctaLink2.textColor, m.style.textDecoration = "none", m.style.fontSize = t.ctaLink2.fontSize, d.appendChild(m);
                        ...
                        if ("before" == "before" ? z(mid, S) : "after" == "after" && T(mid, S), "yes" == t.collapseAndExpandButton.flag) {
                    ...
                    }(config, "body"), "" == config.subHeading.flag && (document.querySelector(".descriptionText").style.paddingBottom = "30px"), "yes" == config.autoHide.flag && "yes" == config.autoHide.countDown) var e = 0,
