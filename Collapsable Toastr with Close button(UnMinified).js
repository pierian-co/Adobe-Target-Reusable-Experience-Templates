            ...
            if (0 == document.querySelectorAll(".psb").length) {
                if (function(t, e) {
                        ...
                        if (config_toastr_V1.background.imageUrl != "") {
                            mid.style.backgroundImage = "url('" + config_toastr_V1.background.imageUrl + "')"
                        } else {
                    ...
                    }(config_toastr_V1, "body"), "" == config_toastr_V1.subHeading.flag && (document.querySelector(".descriptionText").style.paddingBottom = "30px"), "yes" == config_toastr_V1.autoHide.flag && "yes" == config_toastr_V1.autoHide.countDown) var e = 0,
                    n = setInterval(function() {
                        ++e === config_toastr_V1.autoHide.time && (slideToggle(document.getElementById("mid"), 2000), clearInterval(n));
