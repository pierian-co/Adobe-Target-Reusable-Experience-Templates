var passed_json = {
    "overlayStyle": {
        "background": "linear-gradient(321deg, rgba(110,35,35,1) 44%, rgba(201,63,84,1) 100%)",
...
triggerTwoColumnOverlay(passed_json);

function triggerTwoColumnOverlay(passed_json) {
    var settings = {
        "overlayStyle": {
            "background": "linear-gradient(90deg, rgba(2,0,36,1) 0%, rgba(227,177,136,1) 35%, rgba(0,212,255,1) 100%)", // linear-gradient(90deg, rgba(2,0,36,1) 0%, rgba(227,177,136,1) 35%, rgba(0,212,255,1) 100%)
            "backdrop": "rgba(0,0,0,0.8)"
        },
        "heading": {
    ...
    ObjectValues = function (v, k) {
        if (typeof v == "object") {
            ...
            if (myArr[2] != undefined || myArr[2] != null) {
                settings[myArr[0]][myArr[1]][myArr[2]] = v;
            } else {
                settings[myArr[0]][myArr[1]] = v;
            }
        }
    };
