let passed_JSON = {
	...
	"bannerPosition": {
		"selector": "#vueInstance > div.superContainer > div.stage.u_mb--0",
...
function showBanner() {
	let config_banner_v2 = {
		...
		"logoImage": {
			"flag": "yes",
			"url": "https://media0.giphy.com/media/Jn3u29QTykjF2giZTZ/source.gif",
			"width": "30px",
		}
	};
	ObjectValues = function(v, k) {
		if(typeof v == "object") {
			...
			let str = k;
			let myArr = str.split(".");
			config_banner_v2[myArr[0]][myArr[1]] = v;
			console.log(config_banner_v2[myArr[0]][myArr[1]]);
		}
	};
