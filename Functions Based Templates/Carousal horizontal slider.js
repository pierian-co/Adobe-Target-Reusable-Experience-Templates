	...
	try {
		var fun = setInterval(function() {
			...
			if(config_carousal_v2.Product1.Offer.flag == "yes") {
				...
				document.querySelector(".offerDivP1").style.fontFamily = config_carousal_v2.Product1.Offer.fontFamily;
			}
			if(config_carousal_v2.Product2.Offer.flag == "yes") {
				...
				document.querySelector(".offerDivP2").style.fontFamily = config_carousal_v2.Product2.Offer.fontFamily;
			}
			if(config_carousal_v2.Product3.Offer.flag == "yes") {
				...
				document.querySelector(".offerDivP3").style.fontFamily = config_carousal_v2.Product3.Offer.fontFamily;
			}
