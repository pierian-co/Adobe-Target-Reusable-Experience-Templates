...
!function() {
    try {
        var t = setInterval(function() {
            if (0 == document.querySelectorAll(".psb").length) {
                if(document.querySelectorAll(config.bannerPosition.selector).length>0){
                if (function(t, e) {
                        var n = document.createElement("div");
                        n.className = "psb", n.id = "bnr1";
                        var i = "#" + n.id;
                        ...
                        o.className = "descriptionText", o.style.textAlign = "center", o.style.padding = "0px 10px 10px", o.style.color = t.message.colour;
                        var r = document.createElement("span");
                        r.className = "top-text", r.innerText = t.message.text, o.appendChild(r);
                        ...
                        m.setAttribute("href", t.ctaLink2.href), m.setAttribute("id", "closeb"), m.setAttribute("target", "_blank"), m.innerHTML = t.ctaLink2.text, m.style.borderRadius = "6px", m.style.backgroundColor = t.ctaLink2.backgroundColour, m.style.fontFamily = t.ctaLink2.fontFamily, m.style.padding = "5px 10px", m.style.color = t.ctaLink2.textColor, m.style.textDecoration = "none", m.style.fontSize = t.ctaLink2.fontSize, d.appendChild(m);
                        ...
                        f.className = "close", f.id = "closebtn1";
                        var u = "#" + f.id;
                        if ("" == t.closeButton.imageUrl) f.innerHTML = "x", f.style.fontSize = "25px";
                        else {
                            var x = document.createElement("img");
                            x.className = "manImg", x.setAttribute("src", t.closeButton.imageUrl), x.style.width = "20px", x.style.height = "20px", x.style.display = "none", f.appendChild(x)
                        }
                        var y = document.createElement("div");
                        if ("" == t.collapseAndExpandButton.imageUrl) {
                            y.className = "dd-main", y.id = "did1";
                            var h = "#" + y.id,
                                w = document.createElement("div");
                            w.className = "dd-button", w.id = "dd-buttonID", y.appendChild(w)
                        } else {
                            y.className = "dd-main1", y.id = "did1", h = "#" + y.id, y.style.width = "34px", y.style.position = "relative", y.style.margin = "0vh auto 0", y.style.marginBottom = "-18px", y.style.marginTop = "-18px", y.style.zIndex = "2";
                        ...
                        if (C.setAttribute("src", t.logoImage.url), C.setAttribute("align", "left"), C.id = "2ImgId", C.style.display = "none", "yes" == t.animation.flag)
                        ...
                        if (config.background.imageUrl != "") {
                            mid.style.backgroundImage = "url('" + config.background.imageUrl + "')"
                        } else {
                ...
                if (config.collapseAndExpandButton.flag == "yes") {
                    document.querySelector("#did1").onclick = function() {
                        document.querySelector("#did1").classList.toggle("down");
                        slideToggle(document.getElementById("bnr1"), 2000)
                    }
                }
                if (config.closeButton.flag != "yes") {
