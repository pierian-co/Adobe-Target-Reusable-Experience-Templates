...
function ShowOverlay(passed_json) {
	var config_overlay = {
		"overlayStyle": {
			"imgUrl": "",
			"background": "linear-gradient(321deg, rgba(35,90,110,1) 25%, rgba(63,201,188,1) 100%)"
