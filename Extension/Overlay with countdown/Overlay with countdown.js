...
function ShowOverlay(json) {
	var settings = {
		...
		"countdown": {
			"activator": "yes",
			"date": "Jun 10, 2022 12:00:00" // May 25, 2022 12:00:00
		}
	};
	...
	ObjectValues = function(v, k) {
		if(typeof v == "object") {
			...
			console.log(settings[myArr[0]][myArr[1]]);
		}
	};
	ObjectValues(json);
	try {
