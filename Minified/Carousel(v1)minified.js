...
var fun = setInterval(function() {
	...
	if(screen.width < 601) {
		const t = document.querySelector(".slides"),
			o = 100 * (t.childElementCount - 1) * -1;
		let a = 0;

		function e(e = !0) {
			e ? a += a > o ? -100 : -1 * a : a = a < 0 ? a + 100 : o, t.style.left = a + "%", "0%" == t.style.left && (document.querySelector(".prev-slide").style.opacity = 0, document.querySelector(".next-slide").style.opacity = 1), "-100%" == t.style.left && (document.querySelector(".prev-slide").style.opacity = 1, document.querySelector(".next-slide").style.opacity = 1), "-200%" == t.style.left && (document.querySelector(".prev-slide").style.opacity = 1, document.querySelector(".next-slide").style.opacity = 0)
		}
		document.querySelector(".prev-slide").style.opacity = 0, document.querySelector(".next-slide").style.opacity = 1, document.querySelector(".next-slide").addEventListener("click", function() {
			e()
		}), document.querySelector(".prev-slide").addEventListener("click", function() {
