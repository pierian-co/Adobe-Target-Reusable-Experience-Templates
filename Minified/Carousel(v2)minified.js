...
try {
	var fun = setInterval(function() {
		if(screen.width < 601) {
			...
			if(screen.width < 601) {
				const e = document.querySelector(".slides"),
					o = 100 * (e.childElementCount - 1) * -1;
				let a = 0;

				function t(t = !0) {
					t ? a += a > o ? -100 : -1 * a : a = a < 0 ? a + 100 : o, e.style.left = a + "%", "0%" == e.style.left && (document.querySelector(".prev-slide").style.opacity = 0, document.querySelector(".next-slide").style.opacity = 1), "-100%" == e.style.left && (document.querySelector(".prev-slide").style.opacity = 1, document.querySelector(".next-slide").style.opacity = 1), "-200%" == e.style.left && (document.querySelector(".prev-slide").style.opacity = 1, document.querySelector(".next-slide").style.opacity = 0)
				}
				document.querySelector(".prev-slide").style.opacity = 0, document.querySelector(".next-slide").style.opacity = 1, document.querySelector(".next-slide").addEventListener("click", function() {
					t()
				}), document.querySelector(".prev-slide").addEventListener("click", function() {
